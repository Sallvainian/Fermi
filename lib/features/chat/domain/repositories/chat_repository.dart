...
abstract class ChatRepository extends BaseRepository {
  ...
  Future<void> editMessage(
      String chatRoomId, String messageId, String newContent);
  ...
  Future<void> addParticipant(
      String chatRoomId, String userId, ParticipantInfo participantInfo);
  ...
  Future<void> batchUpdateMessageStatus(
      String chatRoomId, List<String> messageIds, MessageStatus status);
}
