...
class DeviceCalendarServiceMobile implements DeviceCalendarServiceInterface {
    ...
    try {
      if (kIsWeb) {
        LoggerService.warning(
          'Calendar permissions not available on web',
      ...
      if (!permissionsResult.isSuccess) {
        LoggerService.warning(
          'Calendar permission request failed: ${permissionsResult.errors}',
          tag: 'DeviceCalendarService',
        );
        return false;
      }
      ...
      if (calendarsResult.isSuccess) {
        LoggerService.info(
          'Calendar access granted and verified',
          tag: 'DeviceCalendarService',
        );
        return true;
      }
      ...
      LoggerService.warning(
        'Calendar access issue after permission grant',
        tag: 'DeviceCalendarService',
      );
      return false;
    } catch (e) {
  ...
  Future<String?> _getOrCreateDefaultCalendar() async {
    try {
      ...
      LoggerService.error(
        'Error getting/creating default calendar',
        tag: 'DeviceCalendarService',
        error: e,
      );
      return null;
  ...
  Future<String?> addCalendarEvent({
    ...
    try {
      ...
      if (finalCalendarId == null) {
        LoggerService.warning(
          'No calendar available for sync',
          tag: 'DeviceCalendarService',
        );
        return null;
      }
      ...
      if (result?.isSuccess == true) {
        LoggerService.info(
          'Event synced to device calendar: ${event.title}',
          tag: 'DeviceCalendarService',
        );
        return result!.data;
      }
      ...
      LoggerService.error(
        'Error syncing event to device calendar',
        tag: 'DeviceCalendarService',
        error: e,
      );
      return null;
  ...
  Future<String?> addAssignmentToCalendar({
    ...
    try {
      ...
      LoggerService.warning(
        'Failed to sync assignment to device calendar',
        tag: 'DeviceCalendarService',
      );
      return null;
    } catch (e) {
      LoggerService.error(
        'Error syncing assignment to device calendar',
        tag: 'DeviceCalendarService',
        error: e,
      );
      return null;
  ...
  Future<bool> updateCalendarEvent({
    ...
    try {
      ...
      if (result?.isSuccess == true) {
        LoggerService.info(
          'Event updated in device calendar: ${event.title}',
          tag: 'DeviceCalendarService',
        );
        return true;
      }
      ...
      LoggerService.error(
        'Error updating event in device calendar',
        tag: 'DeviceCalendarService',
        error: e,
      );
      return false;
  ...
  Future<bool> deleteCalendarEvent({
    ...
    try {
      ...
      if (result.isSuccess) {
        LoggerService.info(
          'Event removed from device calendar: $eventId',
          tag: 'DeviceCalendarService',
        );
        return true;
      }
      ...
      LoggerService.error(
        'Error removing event from device calendar',
        tag: 'DeviceCalendarService',
        error: e,
      );
      return false;
  ...
  RecurrenceRule? _createRecurrenceRule(CalendarEvent event) {
    ...
    return RecurrenceRule(frequency, endDate: event.recurrenceEndDate);
  }
}
