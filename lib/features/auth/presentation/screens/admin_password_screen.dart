...
class _AdminPasswordScreenState extends State<AdminPasswordScreen> {
  ...
  // Hash of admin password - you can change this password by updating the hash
  // Default password: "administrator2024"
  ...
  Future<void> _verifyPassword() async {
    ...
    if (enteredHash == _adminPasswordHash) {
      // Success - save admin verification status
      final prefs = await SharedPreferences.getInstance();
      await prefs.setBool('admin_verified', true);
      await prefs.setInt(
        'admin_verify_time',
      ...
      if (mounted) {
        context.go('/auth/login?role=admin');
      }
    } else {
      // Failed attempt
      _failedAttempts++;
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Enter administrator access password',
