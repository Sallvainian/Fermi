...
class StudentRepositoryImpl extends FirestoreRepository<Student>
  ...
  Future<Student?> getStudentByUserId(String userId) async {
    try {
      ...
      LoggerService.error('Failed to get student by user ID',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  Future<void> enrollInClass(String studentId, String classId) async {
    try {
      ...
      LoggerService.info('Student $studentId enrolled in class $classId',
          tag: _tag);
    } catch (e) {
      LoggerService.error('Failed to enroll student in class',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  Future<void> unenrollFromClass(String studentId, String classId) async {
    try {
      ...
      LoggerService.info('Student $studentId unenrolled from class $classId',
          tag: _tag);
    } catch (e) {
      LoggerService.error('Failed to unenroll student from class',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  @override
  Future<void> enrollInMultipleClasses(
    ...
    try {
      ...
      LoggerService.info(
          'Student $studentId enrolled in ${classIds.length} classes',
          tag: _tag);
    } catch (e) {
      LoggerService.error('Failed to enroll student in multiple classes',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  Future<GradeStatistics?> getStudentOverallStatistics(String studentId) async {
    try {
      ...
      final grades =
          gradesSnapshot.docs.map((doc) => Grade.fromFirestore(doc)).toList();

      return GradeStatistics.fromGrades(grades);
    } catch (e) {
      LoggerService.error('Failed to get student overall statistics',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  Future<Map<String, GradeStatistics>> getStudentStatisticsByClass(
    ...
    try {
      ...
      LoggerService.error('Failed to get student statistics by class',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  Future<void> batchCreateStudents(List<Student> students) async {
    try {
      ...
      await batch.commit();
      LoggerService.info('Batch created ${students.length} students',
          tag: _tag);
    } catch (e) {
      LoggerService.error('Failed to batch create students',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  Future<void> batchUpdateStudents(Map<String, Student> students) async {
    try {
      ...
      await batch.commit();
      LoggerService.info('Batch updated ${students.length} students',
          tag: _tag);
    } catch (e) {
      LoggerService.error('Failed to batch update students',
          tag: _tag, error: e);
      rethrow;
    }
  }
  ...
  Future<bool> isEmailAvailable(String email) async {
    try {
      ...
      LoggerService.error('Failed to check email availability',
          tag: _tag, error: e);
      rethrow;
    }
  }
