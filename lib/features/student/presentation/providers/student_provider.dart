...
class StudentProvider with ChangeNotifier {
  ...
  /// Grade statistics grouped by class ID.
  Map<String, GradeStatistics> get studentStatisticsByClass =>
  ...
  Future<void> loadStudentsByGradeLevel(int gradeLevel) async {
    ...
    try {
      ...
      _studentsSubscription =
          _studentRepository.getStudentsByGradeLevel(gradeLevel).listen(
        (studentList) {
          _students = studentList;
          _setLoading(false);
          notifyListeners();
  ...
  Future<void> loadStudentsByParentEmail(String parentEmail) async {
    ...
    try {
      ...
      _studentsSubscription =
          _studentRepository.getStudentsByParentEmail(parentEmail).listen(
        (studentList) {
          _students = studentList;
          _setLoading(false);
          notifyListeners();
  ...
  Future<void> loadStudentClasses(String studentId) async {
    try {
      ...
      _classesSubscription =
          _classRepository.getStudentClasses(studentId).listen(
        (classList) {
  ...
  Future<void> loadStudentStatistics(String studentId) async {
    try {
      ...
      _overallStatistics =
          await _studentRepository.getStudentOverallStatistics(studentId);

      // Load statistics by class
      _studentStatisticsByClass =
          await _studentRepository.getStudentStatisticsByClass(studentId);
